...
class IQ_Sampling(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "IQ_Sampling")
        ...
        self._freq_range = Range(900, 1100, 1, 1100, 200)
        self._freq_win = RangeWidget(self._freq_range, self.set_freq, "Source Frequency", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.analog_sig_source_x_2 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 1000, 1, 0, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 150, 5, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.samp_rate, 150, 5, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=IQ_Sampling, options=None):
