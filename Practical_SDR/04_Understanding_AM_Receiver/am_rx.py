...
class am_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_1_0 = qtgui.time_sink_f(
            1024, #size
            samp_rate, #samp_rate
            "Resampler Out (Time Domain)", #name
            1, #number of inputs
            None # parent
        )
        ...
        # Connections
        ##################################################
        self.connect((self.analog_am_demod_cf_0, 0), (self.qtgui_freq_sink_x_0_0_0_0, 0))
        self.connect((self.analog_am_demod_cf_0, 0), (self.qtgui_time_sink_x_1, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 5e3, 1000, window.WIN_HAMMING, 6.76))
